...
=item B<-object tls-creds-x509,id=>I<id>B<,endpoint=>I<endpoint>B<,dir=>I</path/to/cred/dir>B<,verify-peer=>I<on|off>
...
=item B<-object filter-buffer,id=>I<id>B<,netdev=>I<netdevid>B<,interval=>I<t>B<[,queue=>I<all|rx|tx>B<]>

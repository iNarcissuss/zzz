...
libs_softmmu=-lutil -lncurses -ltinfo    -lpng12   -ljpeg -lgnutls   -lgnutls   -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0 -lglib-2.0   -lX11  -L$(BUILD_DIR)/dtc/libfdt -lfdt -lpixman-1  
ARCH=tci
CONFIG_DEBUG_TCG=y
STRIP=strip
CONFIG_POSIX=y
...
LIBS_TOOLS+=-lgnutls   -lgnutls   -lgnutls   -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0 -lglib-2.0   -lX11 
EXESUF=
DSOSUF=.so
LDFLAGS_SHARED=-shared
LIBS_QGA+=-lm -pthread -lgthread-2.0 -lrt -lglib-2.0    -lrt

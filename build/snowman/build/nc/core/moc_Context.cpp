...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nc__core__Context_t, stringdata) + ofs \
...
void nc::core::Context::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Context::instructionsChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Context::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Context::treeChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject nc::core::Context::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_nc__core__Context.data,
      qt_meta_data_nc__core__Context,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nc__core__Context.stringdata))

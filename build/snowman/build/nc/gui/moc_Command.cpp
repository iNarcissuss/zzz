...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nc__gui__Command_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 27, 16)
    ...
    "nc::gui::Command\0finished\0\0activityFinished\0"
};
...
void nc::gui::Command::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Command::finished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject nc::gui::Command::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_nc__gui__Command.data,
      qt_meta_data_nc__gui__Command,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__Command.stringdata))

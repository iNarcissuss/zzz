...
#include "../../../src/nc/gui/SectionsView.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nc__gui__SectionsView_t, stringdata) + ofs \
...
const QMetaObject nc::gui::SectionsView::staticMetaObject = {
    { &TreeView::staticMetaObject, qt_meta_stringdata_nc__gui__SectionsView.data,
      qt_meta_data_nc__gui__SectionsView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__SectionsView.stringdata))
        return static_cast<void*>(const_cast< SectionsView*>(this));

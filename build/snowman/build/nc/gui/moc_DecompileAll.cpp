...
#include "../../../src/nc/gui/DecompileAll.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nc__gui__DecompileAll_t, stringdata) + ofs \
...
const QMetaObject nc::gui::DecompileAll::staticMetaObject = {
    { &Command::staticMetaObject, qt_meta_stringdata_nc__gui__DecompileAll.data,
      qt_meta_data_nc__gui__DecompileAll,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__DecompileAll.stringdata))
        return static_cast<void*>(const_cast< DecompileAll*>(this));

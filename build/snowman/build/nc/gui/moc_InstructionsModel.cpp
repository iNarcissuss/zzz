...
#include "../../../src/nc/gui/InstructionsModel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nc__gui__InstructionsModel_t, stringdata) + ofs \
...
const QMetaObject nc::gui::InstructionsModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_nc__gui__InstructionsModel.data,
      qt_meta_data_nc__gui__InstructionsModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__InstructionsModel.stringdata))
        return static_cast<void*>(const_cast< InstructionsModel*>(this));

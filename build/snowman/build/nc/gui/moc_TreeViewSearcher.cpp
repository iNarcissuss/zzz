...
#include "../../../src/nc/gui/TreeViewSearcher.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nc__gui__TreeViewSearcher_t, stringdata) + ofs \
...
void nc::gui::TreeViewSearcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TreeViewSearcher *_t = static_cast<TreeViewSearcher *>(_o);
        switch (_id) {
...
const QMetaObject nc::gui::TreeViewSearcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_nc__gui__TreeViewSearcher.data,
      qt_meta_data_nc__gui__TreeViewSearcher,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__TreeViewSearcher.stringdata))
        return static_cast<void*>(const_cast< TreeViewSearcher*>(this));
    if (!strcmp(_clname, "Searcher"))
        return static_cast< Searcher*>(const_cast< TreeViewSearcher*>(this));

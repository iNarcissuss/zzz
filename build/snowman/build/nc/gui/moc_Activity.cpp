...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_nc__gui__Activity_t, stringdata) + ofs \
...
void nc::gui::Activity::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Activity::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Activity::finished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject nc::gui::Activity::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_nc__gui__Activity.data,
      qt_meta_data_nc__gui__Activity,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nc__gui__Activity.stringdata))
        return static_cast<void*>(const_cast< Activity*>(this));
    if (!strcmp(_clname, "QRunnable"))
        return static_cast< QRunnable*>(const_cast< Activity*>(this));

...
public:
    ...
    void setupUi(QWidget *OrderAndProps)
    {
        ...
        dictionariesNumber = new QLabel(OrderAndProps);
        dictionariesNumber->setObjectName(QString::fromUtf8("dictionariesNumber"));
        dictionariesNumber->setText(QString::fromUtf8(""));

        horizontalLayout->addWidget(dictionariesNumber);
        ...
        infoVerticalLayout = new QVBoxLayout(dictionaryInformation);
        ...
        dictionaryName->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        infoVerticalLayout->addLayout(gridLayout);
        ...
        infoVerticalLayout->addWidget(dictionaryDescriptionLabel);
        ...
        infoVerticalLayout->addWidget(dictionaryDescription);

        infoVerticalSpacer = new QSpacerItem(20, 5, QSizePolicy::Minimum, QSizePolicy::Expanding);

        infoVerticalLayout->addItem(infoVerticalSpacer);

        horizontalSpacer_5 = new QSpacerItem(256, 5, QSizePolicy::Expanding, QSizePolicy::Minimum);

        infoVerticalLayout->addItem(horizontalSpacer_5);

        label_11 = new QLabel(dictionaryInformation);
        label_11->setObjectName(QString::fromUtf8("label_11"));

        infoVerticalLayout->addWidget(label_11);
        ...
        infoVerticalLayout->addWidget(dictionaryFileList);
        ...
        QWidget::setTabOrder(dictionaryOrder, inactiveDictionaries);

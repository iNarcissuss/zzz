...
public:
    ...
    void setupUi(QDialog *FullTextSearchDialog)
    {
        ...
        helpButton = new QPushButton(FullTextSearchDialog);
        ...
        QWidget::setTabOrder(searchLine, headwordsView);
        QWidget::setTabOrder(headwordsView, checkBoxDistanceBetweenWords);
        QWidget::setTabOrder(checkBoxDistanceBetweenWords, distanceBetweenWords);
        QWidget::setTabOrder(distanceBetweenWords, searchMode);
        QWidget::setTabOrder(searchMode, checkBoxArticlesPerDictionary);
        QWidget::setTabOrder(checkBoxArticlesPerDictionary, articlesPerDictionary);
        QWidget::setTabOrder(articlesPerDictionary, matchCase);
        QWidget::setTabOrder(matchCase, OKButton);
    ...
    void retranslateUi(QDialog *FullTextSearchDialog)
    {
        ...
        helpButton->setText(QApplication::translate("FullTextSearchDialog", "Help", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

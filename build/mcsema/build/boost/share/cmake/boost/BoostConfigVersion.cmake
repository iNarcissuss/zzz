...
file(GLOB AVAILABLE_VERSIONFILES 
  RELATIVE ${CWD} 
  "/tmp/mcsema/build/boost/share/boost-*/cmake/BoostConfig.cmake")

message("globbed: ${AVAILABLE_VERSIONFILES}")
if (EXISTS "/tmp/mcsema/build/boost/share/boost-${PACKAGE_FIND_VERSION_MAJOR}.${PACKAGE_FIND_VERSION_MINOR}.${PACKAGE_FIND_VERSION_PATCH}/cmake/BoostConfig.cmake")
  #
  #  Exact version
  #
